...
## Ground truth (Doctrine v11 LOCKED — kernel `c7c0ba17`)
...
Source of truth: [`szl-holdings/lutar-lean@main`](https://github.com/szl-holdings/lutar-lean)

## Products

- **a11oy** — governed-inference command platform → [a-11-oy.com](https://a-11-oy.com)
- **killinchu** — maritime / drone C2 → [huggingface.co/SZLHOLDINGS](https://huggingface.co/SZLHOLDINGS)

## Links

- Company GitHub: [github.com/szl-holdings](https://github.com/szl-holdings)
- Hugging Face org: [huggingface.co/SZLHOLDINGS](https://huggingface.co/SZLHOLDINGS)
